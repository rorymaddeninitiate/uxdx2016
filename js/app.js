...
angular.module('constants', [])
  ...
  .constant('COUNTDOWN', 1476485999000)
    ...
    return {
        ...
        link: function(scope, element, attrs) {
          element.bind('load', function() {
            if(this.naturalWidth/ this.naturalHeight > 3) {
              // console.log('called', this)
              this.className += ' wide2x'
            }
            else if(this.naturalWidth/ this.naturalHeight > 2) {
              this.className += ' wide';
            }
          });
        }
...
$templateCache.put('sponsors/sponsor.html','<section id="partnerPage">\n\n  <div class="container">\n\n    <h1>{{sponsor.sponsor.name}}</h1>\n\n    <div class="row">\n      <div class="col-xs-12 col-sm-4 col-md-3">\n        <span class="imageContainer">\n          <img ng-src="{{sponsor.sponsor.companyLogo}}" alt="{{sponsor.sponsor.name}}" class="page-image" image-dimension>\n        </span>\n        <div class="share-widget">\n          <a ng-if="sponsor.sponsor.url" href="{{sponsor.sponsor.url}}" target="_blank">\n            <i class="fa fa-lg fa-globe"></i>\n            <!-- {{sponsor.sponsor.url}} -->\n          </a>\n          <a ng-if="sponsor.sponsor.social.twitter" href="{{sponsor.sponsor.social.twitter}}" target="_blank">\n            <i class="fa fa-lg fa-twitter"></i>\n            <!-- {{sponsor.sponsor.social.twitter | twitter }} -->\n          </a>\n          <a ng-if="sponsor.sponsor.social.linkedIn" href="{{sponsor.sponsor.social.linkedIn}}" target="_blank">\n            <i class="fa fa-lg fa-linkedin-square"></i>\n            <!-- LinkedIn -->\n          </a>\n          <a ng-if="sponsor.sponsor.social.github" href="{{sponsor.sponsor.social.github}}" target="_blank">\n            <i class="fa fa-lg fa-github"></i>\n            <!-- Github -->\n          </a>\n          <a ng-if="sponsor.sponsor.social.instagram" href="{{sponsor.sponsor.social.instagram}}" target="_blank">\n            <i class="fa fa-lg fa-instagram"></i>\n            <!-- Instagram -->\n          </a>\n        </div>\n      </div>\n\n      <div class="col-xs-12 col-sm-8 col-md-9">\n        <div class="col-xs-12">\n          <p class="page-bio"><div btf-markdown="sponsor.sponsor.bio"></div></p>\n       </div>\n\n     </div>\n  </div>\n\n\n</section>\n');
$templateCache.put('sponsors/sponsors.html','<section id="partnersPage">\n  <div class="container">\n    <h1>Supported By</h1>\n<!--     <partner-list partners="main.sponsors"></partner-list> -->\n    <div class="partner-list row" ng-repeat="partner in partners.partners | orderBy: \'order\'">\n      <!-- <a ng-repeat="sponsor in sponsors.sponsors | orderBy: \'order\'" ui-sref="sponsor({sponsorId: sponsor._id})">\n        <img ng-src="{{sponsor.companyLogo}}" alt="{{sponsor.name}}" class="supporter" image-dimension>\n      </a> -->\n      <div class="col-xs-12 col-sm-6 col-lg-4">\n        <div class="row">\n          <a ui-sref="sponsor({sponsorId: partner._id})">\n            <img ng-src="{{partner.companyLogo}}" alt="{{partner.name}}" class="supporter" image-dimension>\n          </a>\n\n        </div>\n        <!-- <hr> -->\n        <div class="share-widget">\n          <!-- <h4>Connect</h4> -->\n          <!-- <p> -->\n            <a ng-if="partner.url" href="{{partner.url}}" target="_blank"> <i class="fa fa-globe"></i> </a>\n            <a ng-if="partner.social.linkedIn" href="{{partner.social.linkedIn}}" target="_blank"><i class="fa fa-linkedin-square"></i></a>\n            <a ng-if="partner.social.twitter" href="{{partner.social.twitter}}" target="_blank"><i class="fa fa-twitter"></i></a>\n            <a ng-if="partner.social.instagram" href="{{partner.social.instagram}}" target="_blank"><i class="fa fa-instagram"></i></a>\n            <a ng-if="partner.social.github" href="{{partner.social.github}}" target="_blank"><i class="fa fa-github"></i></a>\n          <!-- </p> -->\n        </div>\n      </div>\n      <div class="col-xs-12 col-sm-6 col-lg-8">\n        <a ui-sref="sponsor({sponsorId: partner._id})"><h4>{{partner.name}}</h4></a>\n\n\n        <div btf-markdown="partner.bio | words:50"></div>\n\n      </div>\n      <hr>\n\n    </div>\n\n    <div class="row text-center opportunities">\n      <a ui-sref="exhibition" class="btn btn-lg btn-success large-text-button">Sponsorship and Exhibition Opportunities</a>\n    </div>\n</section>\n\n<footer-block></footer-block>\n');
...
.controller('HomeCtrl', function ($http, BLOG_API, BLOG_URL, COUNTDOWN, conferenceService, $sce, $timeout) {
  'ngInject';
  // this.news = news;
  var self = this;
  this.blog = BLOG_URL;
  ...
  conferenceService.getConference().then(function (conference) {
    self.conference =  conference;
    //parse news
    self.conference.news = JSON.parse(self.conference.news);
    // console.log(self.conference.news);
    ...
    //Parse sponsor images
    self.conference.sponsors.forEach(function (sponsor) {
      sponsor.companyLogo = $sce.trustAsResourceUrl(sponsor.companyLogo);
    })
  });
...
.controller('TicketCtrl', function ($timeout, COUNTDOWN) {
  'ngInject';
...
.config(function ($stateProvider) {
  ...
  .state('sponsor', {
    ...
    templateUrl: 'sponsors/sponsor.html',
    ...
    resolve: {
      ...
      // sessions: ['dataService', '$stateParams', function (dataService, $stateParams) {
      //   return dataService.getSessions({sponsor: $stateParams.id});
      // }]
    }
  })
  .state('sponsors', {
    ...
    controller: 'SponsorsCtrl as partners',
    resolve: {
...
.controller('SponsorCtrl', function (conference, $stateParams, $sce) {
  'ngInject';

  this.sponsor = conference.sponsors.filter(function (sponsor) {
    return sponsor._id.toString() === $stateParams.sponsorId;
  })[0];

  this.sponsor.companyLogo = $sce.trustAsResourceUrl(this.sponsor.companyLogo);

})
.controller('SponsorsCtrl', function (conference, $stateParams, $sce) {
  'ngInject';

  this.partners = conference.sponsors;
  console.log(this.partners)

  this.partners.forEach(function (partner) {
    partner.companyLogo = $sce.trustAsResourceUrl(partner.companyLogo);
  });
...
.controller('AttendeesCtrl', function (conference, $sce, COUNTDOWN, $timeout) {
  'ngInject';
  var self = this;
  this.conference = conference;
  this.attendees = conference.attendees;
  this.attendees.forEach(function (attendee) {
    attendee.profilePic = $sce.trustAsResourceUrl(attendee.profilePic);
  });
