...
$templateCache.put('sponsors/sponsor.html','<section id="partnerPage">\n\n  <div class="container">\n\n    <h1>{{sponsor.sponsor.name}}</h1>\n\n    <div class="row">\n      <div class="col-xs-12 col-sm-4 col-md-3">\n        <span class="imageContainer">\n          <img ng-src="{{sponsor.sponsor.companyLogo}}" alt="{{sponsor.sponsor.name}}" class="page-image">\n        </span>\n        <div class="share-widget">\n          <p ng-if="sponsor.sponsor.url" class="page-link"><a href="{{sponsor.sponsor.url}}" target="_blank"><i class="fa fa-external-link"></i> {{sponsor.sponsor.url}}</a></p>\n          <p class="page-link"><a ng-if="sponsor.sponsor.social.linkedIn" href="{{sponsor.sponsor.social.linkedIn}}" target="_blank"><i class="fa fa-linkedin-square"></i> LinkedIn</a></p>\n          <p class="page-link"><a ng-if="sponsor.sponsor.social.twitter" href="{{sponsor.sponsor.social.twitter}}" target="_blank"><i class="fa fa-twitter"></i>{{sponsor.sponsor.social.twitter | twitter }}</a></p>\n          <p class="page-link"><a ng-if="sponsor.sponsor.social.github" href="{{sponsor.sponsor.social.github}}" target="_blank"><i class="fa fa-github"></i> Github</a></p>\n          <p class="page-link"><a ng-if="sponsor.sponsor.social.instagram" href="{{sponsor.sponsor.social.instagram}}" target="_blank"><i class="fa fa-instagram"></i> Instagram</a></p>\n        </div>\n      </div>\n\n      <div class="col-xs-12 col-sm-8 col-md-9">\n        <div class="col-xs-12">\n          <p class="page-bio"><div btf-markdown="sponsor.sponsor.bio"></div></p>\n       </div>\n\n     </div>\n  </div>\n\n\n</section>\n');
